            ...
            <div class="content-inner">
                ...
                <!--<div class="pane pane0">
                    ...
                    <div class="home-mask">
                        <div class="home-wrap">
                            <h1 class="home-title">Yoga for you.</h1>
                            <h4>Search by studio, teacher, or city</h4>
                            <div class="home-search">
                                <div class="input-group">
                                    <input type="text" class="form-control">
                                    <span class="input-group-btn">
                                    <button class="btn btn-default home-search-btn" type="button">Search</button>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pane pane1">
                    ...
                    <div class="sub-pane sub-pane1 t03">
                        <div class="filter-btn t03"><i class="fa fa-cogs"></i></div>
                        <div class="pane1-head">
                            <h1>find your yoga class:</h1>
                        </div>
                    <button type="button" class="btn btn-default large-round-btn calendar-btn t03"><i class="fa fa-calendar"></i></button>
